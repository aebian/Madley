...
class US_MARINES_JTAC : US_MARINES_DEFAULT_FROGWD // Marines [Joint Terminal Attack Controller]
{
	...
	primary[] = {"rhs_weap_m27iar_grip","rhsusf_acc_anpeq15side","rhsusf_acc_ACOG2_USMC","rhsusf_acc_SFMB556","rhs_mag_30Rnd_556x45_M196_Stanag_Tracer_Red"};
	launcher[] = {""};
...
class US_MARINES_FTL : US_MARINES_DEFAULT_FROGWD // Marines [Fire Team Leader]
{
	...
	backpack[] = {""};
	primary[] = {"rhs_weap_m27iar_grip","rhsusf_acc_ACOG2_USMC","rhsusf_acc_SFMB556","rhs_mag_30Rnd_556x45_M196_Stanag_Tracer_Red"};
	launcher[] = {""};
	magazines[] = {"rhs_mag_30Rnd_556x45_M196_Stanag_Tracer_Red",8,"rhsusf_mag_15Rnd_9x19_JHP",2 };
	items[] += {"ACE_quikclot",3,"ACE_fieldDressing",4,"ACE_packingBandage",4,"ACE_tourniquet",2,"rhs_mag_m18_green",1,"rhs_mag_m18_red",1};
	binoculars[] = {""};
...
class US_MARINES_MG : US_MARINES_DEFAULT_FROGWD // Marines [Heavy Machine Gunner]
{
	...
	vest[] = {"rhsusf_spc_mg"};
	backpack[] = {"B_Kitbag_cbr"};
	primary[] = {"MMG_01_tan_F","rhsusf_acc_EOTECH","bipod_01_F_snd","150Rnd_93x64_Mag"};
	launcher[] = {""};
