...
class RU_VDV_SNP : RU_VDV_RFL_BASE // VDV [Sniper]
{
	uniform[] = {"rhs_uniform_vdv_emr_des"};
	vest[] = {"rhs_6b13_6sh92_radio"};
	backpack[] = {""};
...
class RU_VDV_Grenadier : RU_VDV_RFL_BASE // VDV [Grenadier (RPG-7)]
{
	backpack[] = {"rhs_rpg_empty"};
	primary[] = {"rhs_weap_ak74m_fullplum","rhs_acc_dtk"};
	launcher[] = {"rhs_weap_rpg7","rhs_acc_pgo7v"};
	magazines[] = {"rhs_45Rnd_545X39_7U1_AK",4,"rhs_rpg7_PG7VL_mag",3,"rhs_rpg7_OG7V_mag",2};
	items[] += {"ACE_fieldDressing",4,"ACE_packingBandage",4,"ACE_quikclot",4,"ACE_morphine",1,"ACE_epinephrine",1};
	binoculars[] = {""};
	compass[] = {"ItemCompass"};
	goggles[] = {"rhs_ess_black"};
...
class RU_VDV_DES_Machinegunner_WT : RU_VDV_RFL_BASE // VDV [Machine Gunner / Weapons Team] (Corporal)
{
	uniform[] = {"rhs_uniform_vdv_emr_des"};
	vest[] = {"rhs_6b13_6sh92"};
	backpack[] = {"B_Carryall_oli"};
...
class RU_VDV_DES_Machinegunner_Assistant_WT : RU_VDV_RFL_BASE // VDV [Machine Gunner Assistant / Weapons Team]
{
backpack[] = {"B_Carryall_oli"};
magazines[] = {"rhs_45Rnd_545X39_7U1_AK", 5,"rhs_100Rnd_762x54mmR_7N26",3};
};

class RU_VDV_DES_RFL_AA : RU_VDV_RFL_BASE // VDV [Rifleman Anti-Air]
{
	uniform[] = {"rhs_uniform_vdv_emr_des"};
	vest[] = {"rhs_6b13_6sh92"};
...
class RU_SPC_LEAD : CommonRussia // спецназ [Colonel / Leader] #\ Not Used By Players /#
{
	...
	launcher[] = {""};
	magazines[] = {"rhs_20rnd_9x39mm_SP6",6,"rhs_mag_9x18_8_57N181S",2,"rhs_mag_nspn_green",2,"rhs_mag_nspn_red",2};
...
class RU_SPC_PO : CommonRussia // спецназ [Project Officer]
{
	...
	secondary[] = {"rhs_weap_pb_6p9","rhs_acc_6p9_suppressor","rhs_mag_9x18_8_57N181S"};
	launcher[] = {""};
	magazines[] = {"rhs_45Rnd_545X39_7U1_AK",3,"rhs_mag_9x18_8_57N181S",2,"rhs_mag_nspn_yellow",3,"rhs_mag_an_m14_th3",1};
...
class RU_SPC_OP : CommonRussia // спецназ [Operator]
{
	...
	secondary[] = {"rhs_weap_pb_6p9","rhs_acc_6p9_suppressor","rhs_mag_9x18_8_57N181S"};
	launcher[] = {""};
	magazines[] = {"rhs_20rnd_9x39mm_SP6",11,"rhs_mag_9x18_8_57N181S",2,"rhs_mag_rgn",3,"rhs_mag_nspn_green",3,"rhs_mag_nspn_red",3};
...
class RU_SPC_OP2 : RU_SPC_OP // спецназ [Operator]
{
	...
	magazines[] = {"rhs_75Rnd_762x39mm",5,"rhs_mag_9x18_8_57N181S",3,"rhs_mag_rgn",5,"rhs_mag_nspn_green",3,"rhs_mag_nspn_red",3,"rhs_mag_fakel",3};
	gps[] = {"O_UavTerminal"};
};
...
class RU_SPC_MG : RU_SPC_OP // спецназ [Machine Gunner]
{
	...
	launcher[] = {""};
	magazines[] = {"rhs_100Rnd_762x54mmR_7N26",3,"rhs_mag_9x18_8_57N181S",2,"rhs_mag_nspn_green",4};
	binoculars[] = {""};
	compass[] = {"ItemCompass"};
	goggles[] = {"rhs_ess_black"};
	gps[] = {"ItemGPS"};
...
class RU_SPC_MED : RU_SPC_OP // спецназ [Medic]
{
	...
	launcher[] = {""};
	magazines[] = {"rhs_45Rnd_545X39_7U1_AK",6,"rhs_mag_9x18_8_57N181S",2,"rhs_mag_nspn_yellow",4};
...
class RU_SPC_SNP : RU_SPC_OP // спецназ [Sniper]
{
	...
	launcher[] = {""};
	magazines[] = {"rhs_20rnd_9x39mm_SP6",13,"rhs_mag_9x18_8_57N181S",2,"rhs_mag_nspn_yellow",4};
	binoculars[] = {"ACE_MX2A"};
	compass[] = {"ItemCompass"};
	goggles[] = {"rhs_ess_black"};
	gps[] = {"ItemGPS"};
...
class RU_SPC_SNP_T5000 : RU_SPC_OP // спецназ [Sniper ORSIS T-500]
{
	...
	launcher[] = {""};
	magazines[] = {"rhs_5Rnd_338lapua_t5000",20,"rhs_mag_9x18_8_57N181S",6,"rhs_mag_nspn_yellow",4};
	binoculars[] = {"ACE_MX2A"};
	compass[] = {"ItemCompass"};
...
class RU_SPC_ENG : RU_SPC_OP // спецназ | Engineer
{
	...
	launcher[] = {""};
	magazines[] = {"rhs_30Rnd_762x39mm_U",8,"rhs_mag_9x18_8_57N181S",2,"rhs_mag_nspn_green",3,"rhs_mag_nspn_red",3};
...
class RU_SPC_IGLA : RU_SPC_OP // спецназ [Operator]
{
	...
	launcher[] = {"rhs_weap_igla"};
	magazines[] = {"rhs_30Rnd_762x39mm",10,"rhs_mag_9x18_8_57N181S",2,"rhs_mag_9k38_rocket",2,"rhs_mag_nspn_green",3,"rhs_mag_nspn_red",3};
	binoculars[] = {""};
	compass[] = {"ItemCompass"};
	goggles[] = {"rhs_ess_black"};
	gps[] = {"ItemGPS"};
